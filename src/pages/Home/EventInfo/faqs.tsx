const faqs = [
  {
    ...
    sectionFaqs: [
      ...
      },
      {
        ...
        answer: [
          'Here is the link to register: https://hackillinois.org/register. Interested participants can register until the day of the event, February 25, 2022.',
        ],
      },
      {
